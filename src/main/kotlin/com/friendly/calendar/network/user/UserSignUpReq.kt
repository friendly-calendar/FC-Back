...
data class UserSignUpReq(
    ...
    @field:Size(min = 2, max = 10, message = "nickName 의 Size 는 2 ~ 10 사이입니다.")
    @AlphaNumeric
    val nickName: String?,
    ...
    @field:Size(min = 4, max = 15, message = "id의 Size 는 4 ~ 15 사이입니다.")
    @AlphaNumericWithSpecialChars
    val id: String,

    @field:Size(min = 9, max = 20, message = "password 의 Size 는 9 ~ 20 사이입니다.")
    @AlphaNumericWithSpecialChars
    val password: String,
